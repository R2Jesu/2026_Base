...
/** UNDER CONSTRUCTION - SHELL NOT DEVELOPED OUT
 *  command should throw collected balls from the center of the field to the
 * alliance side of the field by calculating the robots position compared to center field
 * and then calculating the speed needed to get the ball from there over to 
 * the alliance side of the field.  The driver will control the direction of the robot.
 */
...
* Aims with limelight
*/
public class ShooterModeThrowWithPose extends Command {
  @SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})
  
  private final R2Jesu_ShooterSubsystem m_shooterSubsystem;
  private final DriveSubsystem m_drivetrain;

// aim calculations not needed because driver is controlling - or pathplanner
...
*/
   ...
   * Required.
   */
  public ShooterModeThrowWithPose(R2Jesu_ShooterSubsystem shooterSubsystem, DriveSubsystem drivetrain,
...
// this version will not use limelight...  not sure where speed for throwing is getting calculated here
